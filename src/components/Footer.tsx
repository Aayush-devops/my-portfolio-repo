...
import { Heart, ArrowUp, Code, Cloud, Calendar, Slack } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 leading-relaxed mb-3 sm:mb-4 max-w-md text-xs sm:text-sm lg:text-base">
              Bringing together frontend finesse, backend robustness, and
              growing DevOps skills to craft full-stack solutions that are
              scalable, intelligent, and cloud-ready.
            </p>
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="flex items-center gap-1.5 text-cyan-400">
                <Slack className="w-3 h-3 sm:w-4 sm:h-4" />
        ...
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-slate-800/50 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
            <p className=" flex items-center text-slate-400 text-xs sm:text-sm flex items-center gap-1.5">
              Made with <Heart className="w-3 h-3 text-red-400 animate-pulse" />{" "}
              by Ayush Sharma
            </p>
