...
import resumePDF from "../resources/ayushsharma_resume.pdf";
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <button
              ...
              className="group relative flex items-center gap-1.5 px-2.5 py-1.5 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-medium rounded-md hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-cyan-500/20 text-xs overflow-hidden"
            >
            ...
            <div
              className={`relative w-12 h-12 rounded-xl overflow-hidden border-2 border-slate-700/50 transition-all duration-1000 ease-out group ${
                showMobilePhoto
                  ? "opacity-100 scale-100 translate-x-0"
                  : "opacity-0 scale-0 translate-x-4"
              }`}
